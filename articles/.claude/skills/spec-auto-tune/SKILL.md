...
```bash
python3 .claude/skills/gws-utils/scripts/read_doc.py <REF_ID>
```
...
python3 .claude/skills/gws-utils/scripts/clear_tab.py <SPEC_ID> "<TAB_ID>" <END_INDEX>
python3 .claude/skills/gws-utils/scripts/write_tab.py <SPEC_ID> "<TAB_ID>" /tmp/tab_new_content.txt
```
...
for each tab in desired_order:
    NEW_TAB_ID=$(python3 .claude/skills/gws-utils/scripts/create_tab.py <SPEC_ID> "<TAB_TITLE>")
    python3 .claude/skills/gws-utils/scripts/write_tab.py <SPEC_ID> "$NEW_TAB_ID" /tmp/tab_<OLD_TAB_ID>_content.txt
...
for each original tab (from first_affected_pos to end):
    python3 .claude/skills/gws-utils/scripts/delete_tab.py <SPEC_ID> "<ORIGINAL_TAB_ID>"
```
