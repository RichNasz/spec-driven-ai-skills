...
All scripts are called with `python3 ${CLAUDE_PLUGIN_ROOT}/skills/gws-utils/scripts/<script>.py` from the project root.
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gws-utils/scripts/find_tab.py <doc_id> <tab_name>
```
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gws-utils/scripts/clear_tab.py <doc_id> <tab_id> <end_index>
```
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gws-utils/scripts/write_tab.py <doc_id> <tab_id> <content_file>
```
...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gws-utils/scripts/delete_tab.py <doc_id> <tab_id>
```
...
```bash
# Try to find the tab
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gws-utils/scripts/find_tab.py <DOC_ID> "Tab Name"
# Returns: <tabId>|<endIndex>  (exit 0) or error (exit 1)

# If not found — create it:
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gws-utils/scripts/create_tab.py <DOC_ID> "Tab Name"
# Returns: <new_tabId>
