#!/usr/bin/env bash
# Verify C3 — Happy Path (With Reference Docs)
# Checks: four-part report; PART 4 present with inaccuracy detection;
# reference doc unchanged; spec doc unchanged.
set -uo pipefail
...
assert_tab_contains "$ARTICLE_DOC" "Spec Coach" "ACCURACY VERDICT"                     || failed=$((failed + 1))
